...
masterTable_data = read.table("/Volumes/Macintosh HD/Users/pooja.bhat/Dropbox/Paperoutline/figureOutline/paper_ZebrafishSLAMseq/figures/figure5/data//ClassifiedGenes_masterTable.txt",
...
b_split = split(b,b$V11)
pval_ks_4= ks.test(b_split$M$fractionU,b_split$`4`$fractionU)$p.value
pval_ks_1= ks.test(b_split$`1`$fractionU,b_split$M$fractionU)$p.value
pval_ks_2= ks.test(b_split$`2`$fractionU,b_split$M$fractionU)$p.value
pval_ks_3= ks.test(b_split$`3`$fractionU,b_split$M$fractionU)$p.value
