...
tcReads = read.table("/Volumes/Macintosh HD/Users/pooja.bhat/Dropbox/Paperoutline/figureOutline/paper_ZebrafishSLAMseq/figures/figure2/data//numberOfreadsWithTC.txt",
...
RPM_reads = read.table("/Volumes/Macintosh HD/Users/pooja.bhat/Dropbox/Paperoutline/figureOutline/paper_ZebrafishSLAMseq/figures/figure2/data//RPM_allCws.txt",
                       sep="\t",stringsAsFactors = F, header = T)
...
pdf("/Volumes/Macintosh HD/Users/pooja.bhat/Dropbox/Paperoutline/figureOutline/paper_ZebrafishSLAMseq/figures/figure4/plots//clusters_accumulation_topgenes.pdf", height = 4, width = 3)
    
    NMF::aheatmap(log10(fractionDisplaced_split_copy$`1`[,c(5:9)]+1),Rowv = NA,Colv = NA,annRow = F,annCol = F,breaks = seq(0,0.4,0.01),color= RColorBrewer::brewer.pal(n = 9,name = 'Reds'))
    NMF::aheatmap(log10(fractionDisplaced_split_copy$`2`[,c(5:9)]+1),Rowv = NA,Colv = NA,annRow = F,annCol = F,breaks = seq(0,0.4,0.01),color= RColorBrewer::brewer.pal(n = 9,name = 'Reds'))
    ...
    NMF::aheatmap(log10(fractionDisplaced_split_copy$`4`[,c(5:9)]+1),Rowv = NA,Colv = NA,annRow = F,annCol = F,breaks = seq(0,0.4,0.01),color= RColorBrewer::brewer.pal(n = 9,name = 'Reds'))
