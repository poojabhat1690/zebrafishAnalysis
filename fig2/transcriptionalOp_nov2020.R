...
tp1 = tp1[-which(tp1$metadata_add=="ywhabb"),]
...
tp1_samples = conversionRates[conversionRates$name %in% tp1$metadata_add,] %>% dplyr::filter(TP1>maxUntreated)
tp1 = tp1[tp1$metadata_add %in% tp1_samples$name,]


tp2_samples = conversionRates[conversionRates$name %in% tp2$metadata_add,] %>% dplyr::filter(TP2>maxUntreated)
tp2 = tp2[tp2$metadata_add %in% tp2_samples$name,]

tp3_samples = conversionRates[conversionRates$name %in% tp3$metadata_add,] %>% dplyr::filter(TP3>maxUntreated)
tp3 = tp3[tp3$metadata_add %in% tp3_samples$name,]

tp4_samples = conversionRates[conversionRates$name %in% tp4$metadata_add,] %>% dplyr::filter(TP4>maxUntreated)
tp4 = tp4[tp4$metadata_add %in% tp4_samples$name,]

tp5_samples = conversionRates[conversionRates$name %in% tp5$metadata_add,] %>% dplyr::filter(TP5>maxUntreated)
tp5 = tp5[tp5$metadata_add %in% tp5_samples$name,]

tp6_samples = conversionRates[conversionRates$name %in% tp6$metadata_add,] %>% dplyr::filter(TP6>maxUntreated)
tp6 = tp6[tp6$metadata_add %in% tp6_samples$name,]

tp7_samples = conversionRates[conversionRates$name %in% tp7$metadata_add,] %>% dplyr::filter(TP7>maxUntreated)
tp7 = tp7[tp7$metadata_add %in% tp7_samples$name,]

tp8_samples = conversionRates[conversionRates$name %in% tp8$metadata_add,] %>% dplyr::filter(TP8>maxUntreated)
tp8 = tp8[tp8$metadata_add %in% tp8_samples$name,]

tp9_samples = conversionRates[conversionRates$name %in% tp9$metadata_add,] %>% dplyr::filter(TP9>maxUntreated)
tp9 = tp9[tp9$metadata_add %in% tp9_samples$name,]
...
deNovoFrac =reshape2:: melt(deNovoFrac,id.vars = c('time'))
...
fractionTranscriptome = reshape2::melt(fractionTranscriptome,id.vars = c('time'))
